 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}PriceRule" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PriceRuleInfo")
public class PriceRuleInfo {

    @XmlElement(name = "PriceRule")
    protected List<PriceRule> priceRule;
    ...
    public List<PriceRule> getPriceRule() {
        if (priceRule == null) {
            priceRule = new ArrayList<PriceRule>();
        }
